...
class VideoTracker(object):
		...
		def run(self):            
				...
				for path, img, im0s, vid_cap in self.dataset:
					...
					cv2.line(im0, (0, int(3*height/6-height/20)), (width, int(3*height/6-height/20)), (0, 255, 0), thickness=2)
					cv2.line(im0, (0, int(3*height/6+height/5)), (width, int(3*height/6+height/5)), (0, 255, 0), thickness=2)
